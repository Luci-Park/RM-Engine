...
namespace
{
	...
	{
		if (s_TriangleVAO) { glDeleteVertexArrays(1, &s_TriangleVAO); s_TriangleVAO = 0; }
		if (s_TriangleVBO) { glDeleteBuffers(1, &s_TriangleVBO); s_TriangleVBO = 0; }
		if (s_TriangleProgram) { glDeleteProgram(s_TriangleProgram); s_TriangleProgram = 0; }
	}
	// -----------------------------------------------
}
